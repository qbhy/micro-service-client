...
class UserCenterUserProvider implements UserProvider
{
    ...
    {
        /** @var UserCenterSubject $model */
        $model = $this->createModel();

        return $model::findFromSocialite($payload);
    }
     ...
     *
     * @param  \Illuminate\Contracts\Auth\Authenticatable|UserCenterSubject $user
     * @param  array                                                        $credentials
     *
     * @return bool
     */
    ...
    {
        return $user->getIuid() === $credentials['iuid'];
    }
